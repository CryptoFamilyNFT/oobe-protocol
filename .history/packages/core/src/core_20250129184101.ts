...
export class OobeCore {
  ...
  async CreateOobeAgent(genAi: Promise<ChatOpenAI<ChatOpenAICallOptions>>, tools: any | ToolNode<any>, memory: MemorySaver, messageModifier: any) {
    try {
      return createReactAgent({
        llm: await genAi as unknown as BaseChatModel<BaseChatModelCallOptions, AIMessageChunk>,
