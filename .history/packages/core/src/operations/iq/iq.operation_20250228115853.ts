...
export class IQOperation {
    ...
    public static async compressImageBuffer(imageBuffer: Buffer): Promise<Buffer> {
    ...
    public static async compressChunk(chunk: Buffer): Promise<Buffer> {
