...
import { WhirlpoolStrategy, WhirlpoolStrategyJSON } from "@hubbleprotocol/kamino-sdk/dist/kamino-client/accounts";
...
export declare class kaminoOperations {
    ...
    getAllKaminostrategies(): Promise<(WhirlpoolStrategy | null)[]>;
