...
function raydiumAmmProgram(params) {
    return new anchor_1.Program(IDL, params?.programId ?? exports.RAYDIUM_AMM_PROGRAM_ID, params?.provider, new coder_1.RaydiumAmmCoder(IDL));
}
const IDL = {
    "version": "0.3.0",
    "name": "raydium_amm",
...
//# sourceMappingURL=ammProgram.js.map