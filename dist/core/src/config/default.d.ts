...
export declare class ConfigManager {
    ...
    createDefaultConfig(privateKey: string, openAiKey: string, oobeKey: string, solanaEndpoint?: IOfficialEndpoint, solanaUnofficialEndpoints?: IUnofficialEndpoints[], solanaExplorer?: string, merkleDbSeed?: string, merkleRootSeed?: string, strategy_key?: string): IConfiguration;
