...
const kaminoClaimRewaerds_tool_1 = require("./hubble/kaminoClaimRewaerds.tool");
const kaminoDepositShares_tool_1 = require("./hubble/kaminoDepositShares.tool");
const kaminoGetAllStrategies_tool_1 = require("./hubble/kaminoGetAllStrategies.tool");
const kaminoGetAssociateTokens_tools_1 = require("./hubble/kaminoGetAssociateTokens.tools");
const kaminoGetCustomStrategy_tool_1 = require("./hubble/kaminoGetCustomStrategy.tool");
const kaminoGetHolders_tool_1 = require("./hubble/kaminoGetHolders.tool");
const kaminoGetSharePriceStrategy_tool_1 = require("./hubble/kaminoGetSharePriceStrategy.tool");
const kaminoWithdrawShares_tool_1 = require("./hubble/kaminoWithdrawShares.tool");
const keminoCreateMemoWithStrategy_tool_1 = require("./hubble/keminoCreateMemoWithStrategy.tool");
...
async function createSolanaTools(agent) {
    ...
    return [
        ...
        new kaminoClaimRewaerds_tool_1.ClaimRewardsTool(kamino), // ✅ Aggiunto
