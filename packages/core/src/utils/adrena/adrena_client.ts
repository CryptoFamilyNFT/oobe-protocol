...
import {IDL as ADRENA_IDL} from "../helpers/idls/adrena_idls";
...
export default class AdrenaClient {
  ...
  public static async load(agent: Agent): Promise<AdrenaClient> {
    ...
    const custodiesAddresses = mainPool.custodies.filter(
      (custody: any) => !custody.equals(PublicKey.default),
    );
  ...
  public static stakingRewardTokenMint =  new PublicKey("EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v");
