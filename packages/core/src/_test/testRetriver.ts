...
function getUserPDAs(agent: Agent) {
...
function FindParsedOutputTransaction(signatures: ConfirmedSignatureInfo[]) {
...
async function getAllTransactionsFromPDAAccountDb(connection: Connection, pda: PublicKey, transactionsRoot: ConfirmedSignatureInfo[]) {
...
async function getAllTransactionsFromPDAAccountRoot(connection: Connection, pda: PublicKey) {
    const signatures = await connection.getSignaturesForAddress(pda);
...
async function dbContentFetcher(connection: Connection, transactions: any[]) {
...
async function cycleToCatchTxnInMemoAndFindOtherTxContent(connection: Connection, transactions: any[]) {
