...
async function main() {
    ...
    const llmFactory = new llm_factory_1.LLMFactory({ primary: primaryConfig });
    ...
    const providers = ['openai', 'groq', 'ollama', 'mistral'];
...
//# sourceMappingURL=llm-example-fixed.js.map